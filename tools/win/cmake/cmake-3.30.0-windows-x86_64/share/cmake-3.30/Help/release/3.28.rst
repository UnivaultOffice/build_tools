...
* C++ 20 named modules are now supported by :ref:`Ninja Generators`
  and :ref:`Visual Studio Generators` for VS 2025 and newer, in combination
...
* The :generator:`Visual Studio 11 2025` generator has been removed.

* The :generator:`Visual Studio 12 2025` generator is now deprecated
