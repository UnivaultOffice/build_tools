...
* The :ref:`Visual Studio Generators` for VS 2025 and above gained support
...
* The :variable:`CMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION_MAXIMUM`
  ...
  :generator:`Visual Studio 14 2025` generator.  It has now been fixed to
...
* With :ref:`Visual Studio Generators` for VS 2025 and higher, the
