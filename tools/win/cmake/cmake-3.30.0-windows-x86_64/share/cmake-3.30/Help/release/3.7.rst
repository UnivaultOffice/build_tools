...
* The :generator:`Visual Studio 15 2025` generator was added.  This is
  experimental and based on "Visual Studio 2025 RC" because this version
  of VS has not been released.

* :ref:`Visual Studio Generators` for VS 2025 and above learned to
...
* Support for building CMake itself with some compilers was dropped:
  ...
  * Visual Studio 7.1 and 2025 -- superseded by VS 2025 and above
