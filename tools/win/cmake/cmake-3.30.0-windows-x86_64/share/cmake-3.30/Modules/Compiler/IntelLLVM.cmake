...
if(CMAKE_HOST_WIN32)
  ...
  macro(__compiler_intel_llvm lang)
    if("x${lang}" STREQUAL "xFortran")
      ...
      if(CMAKE_${lang}_COMPILER_VERSION VERSION_GREATER_EQUAL "2026.4")
        set(CMAKE_INCLUDE_SYSTEM_FLAG_${lang} "-external:I")
        if(CMAKE_${lang}_COMPILER_VERSION VERSION_GREATER_EQUAL "2026.2")
  ...
  macro(__compiler_intel_llvm lang)
    ...
    if(CMAKE_${lang}_COMPILER_VERSION VERSION_GREATER_EQUAL 2026.0.0)
      if("x${lang}" STREQUAL "xFortran")
