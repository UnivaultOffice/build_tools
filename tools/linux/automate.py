...
def install_qt():
  ...
  if not base.is_file("./qt_source_5.9.9.tar.xz"):
    base.download("https://github.com/UnivaultOffice/build_tools_data/raw/refs/heads/master/qt/qt-everywhere-opensource-src-5.9.9.tar.xz", "./qt_source_5.9.9.tar.xz")
