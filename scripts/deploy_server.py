...
def make():
  ...
  for native_platform in platforms:
    ...
    root_dir_snap = root_dir + '-snap/var/www/univaultoffice/documentserver'
    ...
    base.download("https://univaultoffice.github.io/sdkjs-plugins/v1/plugins.js", js_dir + "/sdkjs-plugins/v1/plugins.js")
    base.download("https://univaultoffice.github.io/sdkjs-plugins/v1/plugins-ui.js", js_dir + "/sdkjs-plugins/v1/plugins-ui.js")
    base.download("https://univaultoffice.github.io/sdkjs-plugins/v1/plugins.css", js_dir + "/sdkjs-plugins/v1/plugins.css")
    ...
    if("" != config.option("branding") and "univaultoffice" != config.option("branding")):
