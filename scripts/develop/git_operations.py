...
class GitOperations:
    ...
    def __init__(self, branding: str = "univaultoffice", base_branch: str = "develop", 
                 branding_url: str = "UNIVAULTOFFICE/univaultoffice.git", branch_name: str = None,
        ...
        Args:
            branding: Branding name (default: univaultoffice)
            base_branch: Base branch to work from (default: develop)
            branding_url: Relative path from git host base (default: UNIVAULTOFFICE/univaultoffice.git)
...
def main():
    ...
    branch_parser.add_argument('--branding', default='univaultoffice', help='Branding name')
    branch_parser.add_argument('--branding-url', default='UNIVAULTOFFICE/univaultoffice.git', help='Relative path from git host base (default: UNIVAULTOFFICE/univaultoffice.git)')
    ...
    remove_parser.add_argument('--branding', default='univaultoffice', help='Branding name')
    remove_parser.add_argument('--branding-url', default='UNIVAULTOFFICE/univaultoffice.git', help='Relative path from git host base (default: UNIVAULTOFFICE/univaultoffice.git)')
