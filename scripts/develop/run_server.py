...
def update_config(args):
  ...
  if ("linux" == platform):
  	...
  	base.cmd_in_dir(base_dir + '/../../', 'python', ['configure.py', '--branch', branch or 'develop', '--develop', '1', '--module', 'server', '--update', '1', '--update-light', '1', '--clean', '0', '--sql-type', 'mysql', '--db-port', '3306', '--db-name', 'univaultoffice', '--db-user', 'root', '--db-pass', 'univaultoffice'] + args)
