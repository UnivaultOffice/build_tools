...
def make():
  ...
  if not base.is_dir(git_dir + "/sdkjs-plugins/v1"):
    ...
    base.download("https://univaultoffice.github.io/sdkjs-plugins/v1/plugins.js", git_dir + "/sdkjs-plugins/v1/plugins.js")
    base.download("https://univaultoffice.github.io/sdkjs-plugins/v1/plugins-ui.js", git_dir + "/sdkjs-plugins/v1/plugins-ui.js")
    base.download("https://univaultoffice.github.io/sdkjs-plugins/v1/plugins.css", git_dir + "/sdkjs-plugins/v1/plugins.css")
