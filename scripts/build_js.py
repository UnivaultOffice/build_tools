...
def correct_sdkjs_licence(directory):
  ...
  if "" == branding or "univaultoffice" == branding:
    return
  ...
  base.replaceInFile(directory + "/word/sdk-all-min.js", "univaultoffice-spellchecker", "r7-spellchecker")
  base.replaceInFile(directory + "/slide/sdk-all-min.js", "univaultoffice-spellchecker", "r7-spellchecker")
  base.replaceInFile(directory + "/cell/sdk-all-min.js", "univaultoffice-spellchecker", "r7-spellchecker")
  return
