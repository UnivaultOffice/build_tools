...
def ninja_windows_make(args, is_64=True, is_debug=False, is_arm=False):
  ...
  if ("line = line.decode('utf8')" in win_toolset_wrapper_file_content or
      "line = line.decode('utf-8')" in win_toolset_wrapper_file_content):
    base.replaceInFile(win_toolset_wrapper_file, "line = line.decode('utf8')", "line = line.decode('mbcs', errors='ignore')")
    base.replaceInFile(win_toolset_wrapper_file, "line = line.decode('utf-8')", "line = line.decode('mbcs', errors='ignore')")
  elif (-1 == win_toolset_wrapper_file_content.find("line = line.decode(")):
    base.replaceInFile(win_toolset_wrapper_file, "for line in link.stdout:\n",
      "for line in link.stdout:\n      line = line.decode('mbcs', errors='ignore')\n")
