...
def process_link_tags(text, root=''):
    ...
    reserved_links = {
        ...
        '/plugin/config': 'https://univaultoffice.github.io/api/docs/plugin-and-macros/structure/configuration/',
        '/docbuilder/basic': 'https://univaultoffice.github.io/api/docs/office-api/usage-api/text-document-api/'
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=f"{root}/https://univaultoffice.github.io/api/site/docs/plugin-and-macros/interacting-with-editors/"  # Default value
    )
