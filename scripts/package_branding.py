...
cert_name = "Univault Technologies"

s3_bucket = "repo-doc-univaultoffice-com"
s3_region = "eu-west-1"
s3_base_url = "https://s3.eu-west-1.amazonaws.com/repo-doc-UNIVAULTOFFICE-com"
...
if utils.is_macos():
  desktop_package_name = "UNIVAULTOFFICE"
  desktop_build_dir = "desktop-apps/macos"
  desktop_branding_dir = "desktop-apps/macos"
  desktop_updates_dir = "build/update"
  desktop_changes_dir = "UNIVAULTOFFICE/update/updates/UNIVAULTOFFICE/changes"
  sparkle_base_url = "https://s3.eu-west-1.amazonaws.com/repo-doc-UNIVAULTOFFICE-com"
