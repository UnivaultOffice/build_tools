...
def make_tar():
  ...
  if not branding.univaultoffice:
...
def make_wheel():
  ...
  builder_dir = "build"
  if utils.is_linux():
    builder_dir = "build/opt/univaultoffice/documentbuilder"

  utils.delete_dir("python")
  utils.copy_dir("../univaultoffice/build_tools/packaging/docbuilder/resources", "python")
  utils.copy_dir(builder_dir, "python/docbuilder/lib", True, True)

  desktop_dir = "../desktop-apps/macos/build/UNIVAULTOFFICE.app/Contents/Resources/converter"
