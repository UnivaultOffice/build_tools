...
def make():
  ...
  for native_platform in platforms:
    ...
    base.download("https://univaultoffice.github.io/sdkjs-plugins/v1/plugins.js", root_dir + "/editors/sdkjs-plugins/v1/plugins.js")
    base.download("https://univaultoffice.github.io/sdkjs-plugins/v1/plugins-ui.js", root_dir + "/editors/sdkjs-plugins/v1/plugins-ui.js")
    base.download("https://univaultoffice.github.io/sdkjs-plugins/v1/plugins.css", root_dir + "/editors/sdkjs-plugins/v1/plugins.css")
    ...
    if isWindowsXP:
      ...
      base.copy_dir(git_dir + "/desktop-apps/common/loginpage/providers/univaultoffice", root_dir + "/providers/univaultoffice")
    else:
