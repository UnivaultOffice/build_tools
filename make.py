...
if config.check_option("module", "desktop"):
  config.extend_option("qmake_addon", "URL_WEBAPPS_HELP=https://univaultoffice.github.io/install/desktop/editors/help/v" + base.get_env('PRODUCT_VERSION') + "/apps")

  if "windows" == base.host_platform():
    config.extend_option("config", "updmodule")
    base.set_env("DESKTOP_URL_UPDATES_MAIN_CHANNEL", "https://univaultoffice.github.io/install/desktop/editors/windows/appcast.json")
    base.set_env("DESKTOP_URL_UPDATES_DEV_CHANNEL", "https://univaultoffice.github.io/install/desktop/editors/windows/appcastdev.json")
    base.set_env("DESKTOP_URL_INSTALL_CHANNEL", "https://github.com/UnivaultOffice/DesktopEditors/releases/latest/download/<file>")
    base.set_env("DESKTOP_URL_INSTALL_DEV_CHANNEL", "https://github.com/UnivaultOffice/DesktopEditors/releases/download/dev/<file>")
