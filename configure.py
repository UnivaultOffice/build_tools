...
parser.add_option("--db-name", action="store", type="string", dest="db-name", default="univaultoffice", help="defines the sql db-name wich will be used")
parser.add_option("--db-user", action="store", type="string", dest="db-user", default="univaultoffice", help="defines the sql db-user wich will be used")
parser.add_option("--db-pass", action="store", type="string", dest="db-pass", default="univaultoffice", help="defines the sql db-pass wich will be used")
...
parser.add_option("--vs-version", action="store", type="string", dest="vs-version", default="", help="version of visual studio (auto-detect if empty)")
...
parser.add_option("--cipd-client-url", action="store", type="string", dest="cipd-client-url", default="", help="URL to CIPD client binary (mirror)")
